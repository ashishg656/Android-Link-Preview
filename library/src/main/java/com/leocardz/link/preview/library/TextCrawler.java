...
public class TextCrawler {
    ...
    public class GetCode extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            Log.w("ashish", "onPreExecute: testing");
            super.onPreExecute();
        }
        ...
        protected Void doInBackground(String... params) {
            ...
            if (urls.size() > 0)
                sourceContent.setFinalUrl(unshortenUrl(extendedTrim(urls.get(0))));
            else
...
//        return checkUrlRedirection(shortURL);
    }

    String checkUrlRedirection(String url) {
        try {
